...
# See function train for all possible parameter and there definition.
    prepare_data.pre_data(input_file_path)
    pred_lstm(dataset='imdb',reload_model=True,output_file_path=output_file_path)

if __name__ == '__main__':
    predict('input.json', 'output.json')
